...
from src.models.encoder import DvmarkEncoder
from src.models.decoder import HiddenDecoder
...
def main():
    ...
    base_cfg = BaseConfig(
        device_id=0,
        output_dir="/home/qty/project2/water2/out/TSCeption_dvmark_hidden",
        task_model_path="/home/qty/project2/water2/model_train/TSCeption_3.14/fold-0",
        identify_model_path="/home/qty/project2/water2/model_train/TSCeption_identify/fold-0"
    )
    model_cfg = ModelConfig(
        task_model_type="TSCeption",
        encoder_type="dvmark",
        decoder_type="hidden"
    )
